...
class Role(BaseModel):
    ...
    @classmethod
    def update_role(cls, session, company_id: int, name: str, new_name: str = None, new_description: str = None) -> dict:
        """
        ...
        try:
            ...
            raise ValueError(f"Role with company_id={company_id} and name='{name}' not found.")
